---
title: 'LeKiwi 시작하기'
description: 'LeKiwi 실습 가이드'
---

import Callout from '../../../../../components/Callout.astro';
import Tabs from '../../../../../components/Tabs.astro';

<Callout type="info" title="LeKiwi 시작하기">
  이 섹션에서는 LeKiwi을 시작 방법을 단계별로 안내합니다.
</Callout>
...
**LeKiwi은** LeRobot 생태계에서 지원하는 저가형 로봇 팔입니다. 
...
LeKiwi을 시작하기 전에 다음 사항들을 확인해주세요:
